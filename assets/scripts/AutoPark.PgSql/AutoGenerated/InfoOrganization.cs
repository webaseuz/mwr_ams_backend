...
[Index("Inn", Name = "uix__info_organization_unique_index_inn", IsUnique = true)]
public partial class InfoOrganization
{
    ...
    public virtual InfoBank? Bank { get; set; }
    ...
    public virtual ICollection<HlNumberTemplate> HlNumberTemplates { get; set; } = new List<HlNumberTemplate>();
    ...
    public virtual ICollection<InfoOrganization> InverseParent { get; set; } = new List<InfoOrganization>();
