...
public partial class InfoContractor
{
    ...
    [InverseProperty("ServiceContractor")]
    ...
    public virtual ICollection<HlDevice> HlDeviceManufacturers { get; set; } = new List<HlDevice>();

    [InverseProperty("ServiceContractor")]
    public virtual ICollection<HlDevice> HlDeviceServiceContractors { get; set; } = new List<HlDevice>();
