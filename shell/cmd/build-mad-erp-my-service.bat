...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-my-service"
...
cd ..
cd ..
cd services\erp\erp-my-service\src\Erp.Service.My.WebApi

Echo ---- Building service...
dotnet publish Erp.Service.My.WebApi.csproj -c Release -o %build_folder%
