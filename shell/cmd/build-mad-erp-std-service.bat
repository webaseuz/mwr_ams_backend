...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-std-service"
...
cd ..
cd ..
cd services\erp\erp-std-service\src\Erp.Service.Std.WebApi

Echo ---- Building service... 
dotnet publish Erp.Service.Std.WebApi.csproj -c Release -o %build_folder%
