...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-hrm-service"
...
cd ..
cd ..
cd services\erp\erp-hrm-service\src\Erp.Service.Hrm.WebApi

Echo ---- Building service... 
dotnet publish Erp.Service.Hrm.WebApi.csproj -c Release -o %build_folder%
