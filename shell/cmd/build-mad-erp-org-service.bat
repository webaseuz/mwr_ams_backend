...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-org-service"
...
cd ..
cd ..
cd services\erp\erp-org-service\src\Erp.Service.Org.WebApi

Echo ---- Building service... 
dotnet publish Erp.Service.Org.WebApi.csproj -c Release -o %build_folder%
