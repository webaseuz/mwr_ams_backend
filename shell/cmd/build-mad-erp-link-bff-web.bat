...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-link-bff-web"
...
cd ..
cd ..
cd services\erp\erp-link-bff-web\src\Erp.Link.Bff.Web.WebApi

Echo ---- Building service... 
dotnet publish Erp.Link.Bff.Web.WebApi.csproj -c Release -o %build_folder%
