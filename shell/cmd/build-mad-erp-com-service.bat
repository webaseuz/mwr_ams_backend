...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-com-service"
...
cd ..
cd ..
cd services\erp\erp-com-service\src\Erp.Service.Com.WebApi

Echo ---- Building service... 
dotnet publish Erp.Service.Com.WebApi.csproj -c Release -o %build_folder%
