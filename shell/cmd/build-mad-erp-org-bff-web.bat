...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-org-bff-web"
...
cd ..
cd ..
cd services\erp\erp-org-bff-web\src\Erp.Org.Bff.Web.WebApi

Echo ---- Building service... 
dotnet publish Erp.Org.Bff.Web.WebApi.csproj -c Release -o %build_folder%
