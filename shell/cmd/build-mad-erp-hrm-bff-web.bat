...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-hrm-bff-web"
...
cd ..
cd ..
cd services\erp\erp-hrm-bff-web\src\Erp.Hrm.Bff.Web.WebApi

Echo ---- Building service... 
dotnet publish Erp.Hrm.Bff.Web.WebApi.csproj -c Release -o %build_folder%
