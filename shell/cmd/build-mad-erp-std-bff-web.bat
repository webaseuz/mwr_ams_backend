...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-std-bff-web"
...
cd ..
cd ..
cd services\erp\erp-std-bff-web\src\Erp.Std.Bff.Web.WebApi

Echo ---- Building service... 
dotnet publish Erp.Std.Bff.Web.WebApi.csproj -c Release -o %build_folder%
