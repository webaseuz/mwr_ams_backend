...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-lms-service"
...
cd ..
cd ..
cd services\erp\erp-lms-service\src\Erp.Service.Lms.WebApi

Echo ---- Building service... 
dotnet publish Erp.Service.Lms.WebApi.csproj -c Release -o %build_folder%
