...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-app-bff-web"
...
cd ..
cd ..
cd services\erp\erp-app-bff-web\src\Erp.App.Bff.Web.WebApi

Echo ---- Building service... 
dotnet publish Erp.App.Bff.Web.WebApi.csproj -c Release -o %build_folder%
