...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-app-service"
...
cd ..
cd ..
cd services\erp\erp-app-service\src\Erp.Service.App.WebApi

Echo ---- Building service... 
dotnet publish Erp.Service.App.WebApi.csproj -c Release -o %build_folder%
