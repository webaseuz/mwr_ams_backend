...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-fin-bff-web"
...
cd ..
cd ..
cd services\erp\erp-fin-bff-web\src\Erp.Fin.Bff.Web.WebApi

Echo ---- Building service... 
dotnet publish Erp.Fin.Bff.Web.WebApi.csproj -c Release -o %build_folder%
