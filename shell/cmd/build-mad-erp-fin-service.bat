...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-fin-service"
...
cd ..
cd ..
cd services\erp\erp-fin-service\src\Erp.Service.Fin.WebApi

Echo ---- Building service... 
dotnet publish Erp.Service.Fin.WebApi.csproj -c Release -o %build_folder%
