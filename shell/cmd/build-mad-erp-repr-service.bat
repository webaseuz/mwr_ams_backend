...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-repr-service"
SET build_folder="%build_root_folder%\app"
SET image=registry.webase.uz/madaniyat/mad-erp-repr-service
...
cd ..
cd ..
cd services\erp\erp-repr-service\src\Erp.Service.Repr.WebApi

Echo ---- Building service... 
dotnet publish Erp.Service.Repr.WebApi.csproj -c Release -o %build_folder%
