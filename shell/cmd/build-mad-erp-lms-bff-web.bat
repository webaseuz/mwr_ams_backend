...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-lms-bff-web"
...
cd ..
cd ..
cd services\erp\erp-lms-bff-web\src\Erp.Lms.Bff.Web.WebApi

Echo ---- Building service... 
dotnet publish Erp.Lms.Bff.Web.WebApi.csproj -c Release -o %build_folder%
