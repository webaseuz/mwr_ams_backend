...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-link-service"
...
cd ..
cd ..
cd services\erp\erp-link-service\src\Erp.Service.Link.WebApi

Echo ---- Building service... 
dotnet publish Erp.Service.Link.WebApi.csproj -c Release -o %build_folder%
