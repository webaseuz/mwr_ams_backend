...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-itg-service-proxy"
...
cd ..
cd ..
cd services\erp\erp-itg-service\src\proxy\Erp.Service.Itg.Proxy.WebApi

Echo ---- Building service... 
dotnet publish Erp.Service.Itg.Proxy.WebApi.csproj -c Release -o %build_folder%
