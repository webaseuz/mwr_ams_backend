...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-repr-bff-web"
SET build_folder="%build_root_folder%\app"
SET image=registry.webase.uz/madaniyat/mad-erp-repr-bff-web
...
cd ..
cd ..
cd services\erp\erp-repr-bff-web\src\Erp.Repr.Bff.Web.WebApi

Echo ---- Building service... 
dotnet publish Erp.Repr.Bff.Web.WebApi.csproj -c Release -o %build_folder%
