...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-dash-bff-web"
...
cd ..
cd ..
cd services\erp\erp-dash-bff-web\src\Erp.Dash.Bff.Web.WebApi

Echo ---- Building service... 
dotnet publish Erp.Dash.Bff.Web.WebApi.csproj -c Release -o %build_folder%
