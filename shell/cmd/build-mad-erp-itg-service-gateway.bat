...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-itg-service-gateway"
...
cd ..
cd ..
cd services\erp\erp-itg-service\src\gateway\Erp.Service.Itg.Gateway.WebApi

Echo ---- Building service... 
dotnet publish Erp.Service.Itg.Gateway.WebApi.csproj -c Release -o %build_folder%
...
Echo ---- prepare docker image 3:55 PM 8/18/2025for production ...
