...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-dash-service"
...
cd ..
cd ..
cd services\erp\erp-dash-service\src\Erp.Service.Dash.WebApi

Echo ---- Building service... 
dotnet publish Erp.Service.Dash.WebApi.csproj -c Release -o %build_folder%
