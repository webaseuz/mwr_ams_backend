...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-adm-bff-web"
...
cd ..
cd ..
cd services\erp\erp-adm-bff-web\src\Erp.Adm.Bff.Web.WebApi

Echo ---- Building service... 
dotnet publish Erp.Adm.Bff.Web.WebApi.csproj -c Release -o %build_folder%
