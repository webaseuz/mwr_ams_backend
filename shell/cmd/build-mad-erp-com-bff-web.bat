...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-com-bff-web"
...
cd ..
cd ..
cd services\erp\erp-com-bff-web\src\Erp.Com.Bff.Web.WebApi

Echo ---- Building service... 
dotnet publish Erp.Com.Bff.Web.WebApi.csproj -c Release -o %build_folder%
