...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-cert-service"
SET build_folder="%build_root_folder%\app"
SET image=registry.webase.uz/madaniyat/mad-erp-cert-service
...
cd ..
cd ..
cd services\erp\erp-cert-service\src\Erp.Service.Cert.WebApi

Echo ---- Building service... 
dotnet publish Erp.Service.Cert.WebApi.csproj -c Release -o %build_folder%
