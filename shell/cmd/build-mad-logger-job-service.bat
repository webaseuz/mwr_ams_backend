...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-logger-job-service"
...
cd ..
cd ..
cd services\erp\erp-logger-job-service\src\Erp.Service.Logger.Job.WebApi

Echo ---- Building service... 
dotnet publish Erp.Service.Logger.Job.WebApi.csproj -c Release -o %build_folder%
