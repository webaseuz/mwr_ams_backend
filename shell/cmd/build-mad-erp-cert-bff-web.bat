...
SET shell_folder=%CD%
SET build_root_folder="c:\mad-build\mad-erp-cert-bff-web"
SET build_folder="%build_root_folder%\app"
SET image=registry.webase.uz/madaniyat/mad-erp-cert-bff-web
...
cd ..
cd ..
cd services\erp\erp-cert-bff-web\src\Erp.Cert.Bff.Web.WebApi

Echo ---- Building service... 
dotnet publish Erp.Cert.Bff.Web.WebApi.csproj -c Release -o %build_folder%
