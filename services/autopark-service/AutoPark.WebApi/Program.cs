...
using AutoPark.WebApi;
using AutoPark.WebApi.Extensions;
...
builder.Services.AddIntagration(AppSettings.Instance.Integration.YhxbbHttpConfig);
...
//app.UseConfiguredExceptionHandling(AppSettings.Instance.ClientErrors); // wrap erro
...
app.MapControllers();
app.MapHub<TrackingInfoHub>("/trackingInfoHub").RequireCors("SignalRCors");
