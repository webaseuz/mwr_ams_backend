...
public class GetPresentNotificationBriefPageResultHandler :
    IRequestHandler<GetPresentNotificationBriefPageResultQuery, PagedResultWithActionControls<PresentNotificationBriefDto>>
{
    private readonly IReadEfCoreContext _context;
    private readonly IMapProvider _mapper;
    private readonly IAsyncAppAuthService _authService;
    public GetPresentNotificationBriefPageResultHandler(
