...
public class RevokeExpenseCommandHandler :
    IRequestHandler<RevokeExpenseCommand, IHaveId<long>>
{
    private readonly IWriteEfCoreContext _context;
    private readonly IMapProvider _mapper;
    private readonly IStorageAsyncService _storageAsyncService;
    private readonly IDocumentHistoryService _documentHistoryService;
    public RevokeExpenseCommandHandler(IWriteEfCoreContext context,
                                       IMapProvider mapper,
