...
public class CancelRefuelCommandHandler :
    IRequestHandler<CancelRefuelCommand, IHaveId<long>>
{
    ...
    public CancelRefuelCommandHandler(IWriteEfCoreContext context,
