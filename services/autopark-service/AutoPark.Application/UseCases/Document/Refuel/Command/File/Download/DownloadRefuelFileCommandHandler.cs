...
public class DownloadRefuelFileCommandHandler :
    IRequestHandler<DownloadRefuelFileCommand, (byte[], string)?>
{
    private readonly IStorageAsyncService _storageAsyncService;
    private readonly IReadEfCoreContext _context;
    public DownloadRefuelFileCommandHandler(IStorageAsyncService storageAsyncService, IReadEfCoreContext context)
    {
    ...
    public async Task<(byte[], string)?> Handle(
        DownloadRefuelFileCommand request,
