...
public class DriverService : IDriverService
{
    ...
    public DriverService(IMapProvider mapper, IWriteEfCoreContext context, IStorageAsyncService storageAsyncService)
    {
        _mapper = mapper;
        _context = context;
        _storageAsyncService = storageAsyncService;
    }
    public async Task<IHaveId<int>> CreateAsync(CreateDriverCommand request, CancellationToken cancellationToken)
    {
    ...
    private async Task<Person> CreatePersonAsync(CreatePersonCommand personCommand, CancellationToken cancellationToken)
    {
