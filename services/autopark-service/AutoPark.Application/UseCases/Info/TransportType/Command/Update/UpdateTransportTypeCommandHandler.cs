...
public class UpdateTransportTypeCommandHandler :
    IRequestHandler<UpdateTransportTypeCommand, IHaveId<int>>
{
    private readonly IWriteEfCoreContext _context;
    private readonly IMapProvider _mapper;

    public UpdateTransportTypeCommandHandler(
    ...
    public async Task<IHaveId<int>> Handle(
        UpdateTransportTypeCommand request,
