...
public class UpdateOilTypeCommandHandler :
    IRequestHandler<UpdateOilTypeCommand, IHaveId<int>>
{
    private readonly IWriteEfCoreContext _context;
    private readonly IMapProvider _mapper;

    public UpdateOilTypeCommandHandler(
