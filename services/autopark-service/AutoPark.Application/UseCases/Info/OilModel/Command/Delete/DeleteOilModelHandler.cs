...
public class DeleteOilModelHandler :
    IRequestHandler<DeleteOilModelCommand, SuccessResult<bool>>
{
    private readonly IWriteEfCoreContext _context;
    private readonly IEntityRelationService _relationService;

    public DeleteOilModelHandler(
    ...
    public async Task<SuccessResult<bool>> Handle(
        DeleteOilModelCommand request,
        CancellationToken cancellationToken)
    {
        var entity = await _context.OilModels
            .IsSoftActive()
        ...
        var validateReslult = await _relationService.HasActiveRelationsWithIdAsync<OilModel, int>(entity.Id);
