...
public class DeleteTireModelHandler :
    IRequestHandler<DeleteTireModelCommand, SuccessResult<bool>>
{
    private readonly IWriteEfCoreContext _context;
    private readonly IEntityRelationService _relationService;

    public DeleteTireModelHandler(
    ...
    public async Task<SuccessResult<bool>> Handle(
        DeleteTireModelCommand request,
        CancellationToken cancellationToken)
    {
        ...
        var validateReslult = await _relationService.HasActiveRelationsWithIdAsync<TireModel, int>(entity.Id);
