...
public class UpdateTransportBrandCommandHandler :
    IRequestHandler<UpdateTransportBrandCommand, IHaveId<int>>
{
    private readonly IWriteEfCoreContext _context;
    private readonly IMapProvider _mapper;

    public UpdateTransportBrandCommandHandler(
    ...
    public async Task<IHaveId<int>> Handle(
        UpdateTransportBrandCommand request,
