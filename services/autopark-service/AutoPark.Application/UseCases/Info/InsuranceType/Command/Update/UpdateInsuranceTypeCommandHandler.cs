...
public class UpdateInsuranceTypeCommandHandler :
    IRequestHandler<UpdateInsuranceTypeCommand, IHaveId<int>>
{
    private readonly IWriteEfCoreContext _context;
    private readonly IMapProvider _mapper;

    public UpdateInsuranceTypeCommandHandler(
    ...
    public async Task<IHaveId<int>> Handle(
        UpdateInsuranceTypeCommand request,
