...
namespace AutoPark.Infrastructure.Security;
    ...
    IAsyncAppAuthService
{
    ...
    public async Task<UserAuthModel> GetUserAsync(string token)
    {
        var isAuthenticated = await IsAuthenticatedAsync(token);
