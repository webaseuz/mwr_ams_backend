...
{
    [Authorize(AutoparkPermissionCode.TransportSettingView)]
    [HttpGet]
    ...
    [Authorize(AutoparkPermissionCode.TransportSettingCreate)]
    [HttpPost]
    ...
    [Authorize(AutoparkPermissionCode.TransportSettingEdit)]
    [HttpPost]
    ...
    [Authorize(AutoparkPermissionCode.TransportSettingDelete)]
    [HttpPost]
