...
public class KeycloakIdentityProvider : IIdentityProvider
{
    ...
    public async Task<bool> CreateUserAsync(User user, string password)
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            string url = $"{InfrastructureSettings.InfrastructureInstance.Idp.BaseUrl}/admin/realms/{InfrastructureSettings.InfrastructureInstance.Idp.Realm}/users";
    ...
    public async Task<User> GetUserAsync(long userId)
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            string url = $"{InfrastructureSettings.InfrastructureInstance.Idp.BaseUrl}/admin/realms/{InfrastructureSettings.InfrastructureInstance.Idp.Realm}/users/{user.IdentityKey}";
    ...
    private async Task<bool> ResetPasswordAsync(string keycloakUserId, string newPassword, KeycloakToken token)
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            string url = $"{InfrastructureSettings.InfrastructureInstance.Idp.BaseUrl}/admin/realms/{InfrastructureSettings.InfrastructureInstance.Idp.Realm}/users/{keycloakUserId}/reset-password";
