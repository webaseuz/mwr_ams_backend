...
internal sealed class DownloadMobileExpenseFileCommandHandler(
    IApplicationDbContext context,
    IWbStorageService wbStorageService) : IRequestHandler<ExpenseMobileFileDownloadCommand, (byte[], string)?>
{
    public async Task<(byte[], string)?> Handle(
        ExpenseMobileFileDownloadCommand request,
