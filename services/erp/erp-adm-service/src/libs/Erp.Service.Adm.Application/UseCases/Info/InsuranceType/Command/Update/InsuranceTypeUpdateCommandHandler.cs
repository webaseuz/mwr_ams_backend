...
internal sealed class InsuranceTypeUpdateCommandHandler(
    IApplicationDbContext context,
    ILocalizationBuilder localizationBuilder) : IRequestHandler<InsuranceTypeUpdateCommand, bool>
{
    public async Task<bool> Handle(InsuranceTypeUpdateCommand request, CancellationToken cancellationToken)
    {
        ...
        context.InsuranceTypeTranslates.RemoveRange(entity.Translates);
