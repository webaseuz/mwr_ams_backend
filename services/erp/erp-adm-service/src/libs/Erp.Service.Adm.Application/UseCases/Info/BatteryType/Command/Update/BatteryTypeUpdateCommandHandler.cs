...
internal sealed class BatteryTypeUpdateCommandHandler(
    IApplicationDbContext context,
    ILocalizationBuilder localizationBuilder) : IRequestHandler<BatteryTypeUpdateCommand, bool>
{
    public async Task<bool> Handle(BatteryTypeUpdateCommand request, CancellationToken cancellationToken)
    {
        ...
        context.BatteryTypeTranslates.RemoveRange(entity.Translates);
