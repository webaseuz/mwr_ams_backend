...
internal sealed class DistrictUpdateCommandHandler(
    IApplicationDbContext context,
    ILocalizationBuilder localizationBuilder) : IRequestHandler<DistrictUpdateCommand, bool>
{
    public async Task<bool> Handle(DistrictUpdateCommand request, CancellationToken cancellationToken)
    {
        ...
        context.DistrictTranslates.RemoveRange(entity.Translates);
