...
public class OilModelDtoProfile : CultureProfile
{
    public OilModelDtoProfile()
    {
        ...
        CreateMap<OilModel, OilModelDto>()
         ...
         .ForMember(src => src.OilTypeName, conf => conf.MapFrom(ent => ent.OilType.Translates.AsQueryable().FirstOrDefault(OilTypeTranslate.GetExpr(TranslateColumn.full_name, cultureId)).TranslateText ?? ent.OilType.FullName))
