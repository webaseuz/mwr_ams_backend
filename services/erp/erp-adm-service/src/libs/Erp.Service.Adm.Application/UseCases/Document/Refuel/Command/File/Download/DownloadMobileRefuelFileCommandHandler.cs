...
internal sealed class DownloadMobileRefuelFileCommandHandler(
    IApplicationDbContext context,
    IWbStorageService wbStorageService) : IRequestHandler<RefuelMobileFileDownloadCommand, (byte[], string)?>
{
    public async Task<(byte[], string)?> Handle(RefuelMobileFileDownloadCommand request,
