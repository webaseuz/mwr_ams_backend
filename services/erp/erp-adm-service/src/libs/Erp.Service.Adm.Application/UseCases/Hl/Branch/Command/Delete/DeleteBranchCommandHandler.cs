...
internal sealed class DeleteBranchCommandHandler(
    ...
    ILocalizationBuilder localizationBuilder) : IRequestHandler<BranchDeleteCommand, bool>
{
    public async Task<bool> Handle(BranchDeleteCommand request, CancellationToken cancellationToken)
    {
