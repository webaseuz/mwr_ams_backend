    ...
    IHaveSoftStateId
{
    ...
    [InverseProperty(nameof(ServiceApplication.ExecutorType))]
    public virtual ICollection<ServiceApplication> ServiceApplications { get; set; } = new List<ServiceApplication>();

    [InverseProperty(nameof(ExecutorTypeTranslate.Owner))]
    public virtual ICollection<ExecutorTypeTranslate> Translates { get; set; } = new List<ExecutorTypeTranslate>();
