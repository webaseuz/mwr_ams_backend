...
public class DepartmentBriefDtoProfile : Profile
{
    public DepartmentBriefDtoProfile()
    {
        ...
        CreateMap<Department, DepartmentBriefDto>()
            ...
            .ForMember(src => src.BranchName, conf => conf.MapFrom(ent => ent.State.Translates.AsQueryable().FirstOrDefault(StateTranslate.GetExpr(TranslateColumn.full_name, lang)).TranslateText ?? ent.Branch.FullName));
