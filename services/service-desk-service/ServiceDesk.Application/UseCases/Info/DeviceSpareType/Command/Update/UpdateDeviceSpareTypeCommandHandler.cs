...
public class UpdateDeviceSpareTypeCommandHandler :
    IRequestHandler<UpdateDeviceSpareTypeCommand, IHaveId<int>>
{
    private readonly IWriteEfCoreContext _context;
    private readonly IMapProvider _mapper;

    public UpdateDeviceSpareTypeCommandHandler(
    ...
    public async Task<IHaveId<int>> Handle(
		UpdateDeviceSpareTypeCommand request, 
