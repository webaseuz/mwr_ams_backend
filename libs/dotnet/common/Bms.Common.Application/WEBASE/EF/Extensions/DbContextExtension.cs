...
public static class DbContextExtension
{
    public static void ResolveModules<TModuleCodeEnum,
                                      ...
                                      TModuleTranslate,
                                      TModuleSubGroup,
                                      TModuleSubGroupTranslate>(this IDbContext context)
                                                                             ...
                                                                             new()
    {
        ...
        var subGroupDescs = PermissionCodeHelper.GetDescriptions<TModuleCodeEnum>();

        foreach (KeyValuePair<string, PermissionSubGroupDescription> subGroupDesc in subGroupDescs)
        {
            ...
            if (moduleSubGroup == null)
            {
                moduleSubGroup
                    = new TModuleSubGroup
                    {
                        ...
                        GroupId = subGroupDesc.Value.PermissionGroupId
                    };
            ...
            else
            {
                if (
                    ...
                    moduleSubGroup.GroupId != subGroupDesc.Value.PermissionGroupId)
                {
                    moduleSubGroup.ShortName = subGroupDesc.Value.ShortName;
                    moduleSubGroup.FullName = subGroupDesc.Value.FullName;
                    moduleSubGroup.GroupId = subGroupDesc.Value.PermissionGroupId;
            ...
            foreach (var moduleDesc in subGroupDesc.Value.PermissionCodes)
            {
                TModule val5
        ...
        var moduleCodes
            = subGroupDescs.SelectMany(a => a.Value.PermissionCodes.Select((PermissionCodeDescription a) => a.Code))
                           .ToHashSet();
