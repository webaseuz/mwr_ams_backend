...
public class ApplicationDbContext : WbDbContext, IApplicationDbContext
{
    ...
    public DbSet<RowChangeLog> RowChangeLogs { get; set; }
        ...
        : base(options)
    {
        ...
        Config.AutoSetProperties.StateId.Enabled = false;
    ...
    {
        string connectionString = _databaseConfig.AppDatabase.ConnectionString;
    ...
    protected override object GetCurrentUserId()
    {
